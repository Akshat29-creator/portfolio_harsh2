...
A developer portfolio packed with interactive 3D animations, smooth transitions, and a modern aesthetic. Built with Next.js, React, TypeScript, Tailwind CSS, GSAP, and Spline 3D.
...
This site can be easily deployed on **Vercel** or any modern hosting provider:

1. Push your code to your GitHub repository
2. Connect the repository to [Vercel](https://vercel.com)
3. Add your environment variables in the Vercel dashboard
4. Vercel handles automatic deployments on every push
